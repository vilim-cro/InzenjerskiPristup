	...
	\end{itemize}
		...
		\end{packed_item}
			...
			\subsection{Opis tablica}
				...
				\textit{Korisnik: ovaj entitet sadrži sve informacije o korisniku aplikacije. Sadrži atribute: KorisnikId, Ime, Prezime, E-mail, Zaporka, KorisnickoIme, JeAdmin, ZadnjiLogin, JeAktivan, DatumZaposlenja, SpecijalizacijaId. KorisnikId je primarni ključ. SpecijalizacijaId je strani ključ. 
				...
				Many-to-many veza s entitetom SpecijalizacijaRačunovođe preko atributa SpecijalizacijaId.}\\
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}SpecijalizacijaId	& INT &  jedinstveni identifikator specijalizacije (SpecijalizacijaRačunovođe.SpecijalizacijaId)	\\ \hline
				\end{longtblr}
				...
				\textit{SpecijalizacijaRačunovođe: ovaj entitet sadrži sve informacije o specijalizacijama računovođa. Sadrži atribute: SpecijalizacijaId, SpecijalizacijaIme. SpecijalizacijaId je primarni ključ.
				Veza s entitetom SpecijalizacijaRačunovođe su: Many-to-many veza s entitetom Korisnik preko atributa SpecijalizacijaId.}\\
			...
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{slike/er_diagram.png} %veličina u odnosu na širinu linije
